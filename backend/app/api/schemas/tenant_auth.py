...
class TenantLoginResponse(BaseModel):
    """Login response for customer identity; tenant context may be absent."""
    ...
    tenant_id: str | None = Field(None, description="Selected tenant ID when unambiguous")
    role: str | None = Field(None, description="Current role when one tenant is selected")
...
class TenantApplicationStatus(BaseModel):
    """Latest tenant application visible to the customer."""
