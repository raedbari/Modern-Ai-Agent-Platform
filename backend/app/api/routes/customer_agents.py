...
class AgentCreateRequest(BaseModel):
    ...
    knowledge_mode: str = Field(default="preferred", pattern=r"^(required|preferred|disabled)$")
...
class AgentUpdateRequest(BaseModel):
    ...
    system_prompt: str | None = Field(default=None, max_length=10_000)
    knowledge_mode: str | None = Field(default=None, pattern=r"^(required|preferred|disabled)$")
    contact_message: str | None = Field(default=None, max_length=1_000)
